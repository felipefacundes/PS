...
WV=wine-4.14-1-x86_64
GN=dmc5
SN="DmC 5 - Devil May Cry 2019"
CME="Jogo de Ação"
...
############ dependência necessária para este jogo
cd ~/.jogos/wineprefixes/"$GN"/drive_c/windows/system32/
rm -f mfplat.dll
#wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/libraries/mfplat.dll
#~/.jogos/scripts/winetricks mfplat=native > /dev/null 2>&1
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
