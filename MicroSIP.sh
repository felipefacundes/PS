...
WV=wine-staging-6.6-1-x86_64
GN=MicroSIP
SN="MicroSIP"
CME="Softphone SIP portátil de código aberto para Windows baseado em pilha PJSIP"
...
wget -nc https://www.opencode.net/felipefacundes/free-games/raw/master/MicroSIP-3.20.5.exe
