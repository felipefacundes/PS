...
cd ~/.PlayOnGit/setups/
rm -f Kindle-for-PC-1-26-55076.exe
rm -f epub_conv.exe

Test_Mirror_Sourceforge
Get "$Mirror"/project/gj-others/all/Kindle-for-PC-1-26-55076.exe
Get "$Mirror"/project/gj-others/all/epub_conv.exe
cp -f Kindle-for-PC-1-26-55076.exe "$WINEPREFIX/drive_c" #For fix Option

"$W"/bin/wine epub_conv.exe
Wkill
