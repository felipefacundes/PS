...
cd ~/.jogos/setups/
#wget -nc https://www.opencode.net/felipefacundes/free-games/raw/master/BRCZ.tar.xz
wget -nc https://www.opencode.net/felipefacundes/free-games/raw/master/BR5CZ.tar.xz
tar -xf BR5CZ.tar.xz
#"$W"/bin/wine BRISADOS_cs16full.exe
"$W"/bin/wine BR5CZ.exe
