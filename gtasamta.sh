...
GN=gtasamta
SN="GTA SA"
CME="GTA: San Andreas is one of the most famous games and one of the most popular titles in the GTA series around the world."
...
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/-/raw/master/MTGAInstaller_0.1.2088.756640.msi
