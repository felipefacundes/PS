...
export GN="gtasamta"
export SN="Multi Theft Auto"
export CME="GTA: San Andreas is one of the most famous games and one of the most popular titles in the GTA series around the world."
...
cd ~/.PlayOnGit/setups/
rm -f MTGAInstaller_0.1.2088.756640.msi
Get https://www.opencode.net/felipefacundes/free-games/-/raw/master/MTGAInstaller_0.1.2088.756640.msi
