...
export GN="SonicFlow"
export SN="Sonic Flow (Demo)"
export CME="Fan Created Sonic Game."
...
EXE0="DashEngine"
DIR0="$WINEPREFIX/drive_c/SF2 Next Dimension 1.20 SAGE2020"
EXE1="MugenEngine.exe"
DIR1="$WINEPREFIX/drive_c/Soc Flow - Demo 1"
...
Game_Actions=`zenity \
    ...
    --column 'Action' \
    TRUE "Run ${SN} Next Dimension 1.20" \
    FALSE "Run ${SN} Demo 1" \
    FALSE 'WineConfig' \
    FALSE 'Winetricks' \
