...
export GN="MicroSIP"
export SN="MicroSIP"
export CME="MicroSIP (скачать микросип) is a portable SIP softphone based on the PJSIP stack available for Microsoft Windows operating systems. It facilitates high quality VoIP calls (p2p)"
