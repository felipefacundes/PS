...
export GN="Borderlands.The.Pre.Sequel"
export SN="Borderlands The Pre Sequel"
export CME="Discover the story behind Borderlands 2 villain, Handsome Jack, and his rise to power."
