...
export GN="dmc5"
export SN="DmC - Devil May Cry 2019"
export CME="In this retelling of Dante's origin story which is set against a contemporary backdrop, DmC Devil May Cry retains the stylish action."
