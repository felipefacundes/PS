...
EXE="Steam.exe"
cd "$WINEPREFIX/drive_c/Program Files (x86)/Epic Games/Launcher/Portal/Binaries/Win32"cd "/home/$USER/.jogos/wineprefixes/$GN/drive_c/Program Files/Steam/"
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 223220 \
