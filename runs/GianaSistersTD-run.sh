...
export GN="GianaSistersTD"
export SN="Giana Sisters: Twisted Dreams"
export CME="Giana Sisters: Twisted Dreams combines the challenge of retro era platforming with graphics that pack a visual punch and tight controls."
