...
export GN="AncestorsTHumOdyssey"
export SN="Ancestors: The Humankind Odyssey"
export CME="Ancestors: The Humankind Odyssey is a third-person open world survival game where you Explore, Expand, and Evolve to advance your clan to the next generation"
