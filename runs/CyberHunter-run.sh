...
export GN="CyberHunter"
export SN="Cyber Hunter"
export CME="Cyber Hunter Battle Royale"
...
EXE0="launcher.exe"
DIR0="$WINEPREFIX/drive_c/Program Files (x86)/Cyber Hunter"
