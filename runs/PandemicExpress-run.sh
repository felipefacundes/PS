...
GN=PandemicExpress
SN="Pandemic Express - Zombie Escape"
CME="In Pandemic Express - Zombie Escape, a group of humans try to outrun a player-controlled swarm of infected."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 939510 \
