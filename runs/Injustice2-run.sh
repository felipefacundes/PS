...
export GN="Injustice2"
export SN="Injustice 2"
export CME="Injustice 2 is a big, bold, expansive love letter to fans of DC comics and fighting games in general, and its sequel improves on the original in most every way."
