...
export GN="MagicTheGatheringArena"
export SN="Magic The Gathering Arena"
export CME="Magic: The Gathering Arena or MTG Arena is a free digital collectible card game."
...
EXE0="MTGALauncher.exe"
DIR0="$WINEPREFIX/drive_c/Program Files (x86)/Wizards of the Coast/MTGA/MTGALauncher/"
