...
export GN="warframe"
export SN="Warframe"
export CME="Ninjas Play Free. A third-person, co-op focused action game at its core, Warframe situates players as members of the Tenno race."
