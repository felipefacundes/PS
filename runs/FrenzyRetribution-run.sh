...
export GN="FrenzyRetribution"
export SN="Frenzy Retribution"
export CME="This hardcore hard style with high penalty and high reward requires players to deeply understand."
