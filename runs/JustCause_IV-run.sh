...
export GN="JustCause_IV"
export SN="Just Cause 4"
export CME="Just Cause 4 Reloaded includes additional premium content as well as all previously released improvements and additions to the game."
