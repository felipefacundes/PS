...
CME="Sonic and the All-Stars cast line up on the starting grid once again to battle for supremacy in the ultimate race."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 212480 \
