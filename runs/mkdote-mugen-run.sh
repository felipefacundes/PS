...
CME="Jogo de luta baseado em Mugen"
...
cd "$WINEPREFIX/drive_c/MK Defenders of the Earth v3.3.7"
"$W"/bin/wine "MKDE v3.3.7.exe" 2>&1 | tee /dev/stderr | sed -u -n -e '/trace/ s/.*approx //p' | osd_cat --lines=1 --color=yellow --outline=1 --pos=top --align=left
