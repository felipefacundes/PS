...
export GN="ZombieArmy4"
export SN="Zombie Army 4"
export CME="Hitler's hordes are back in this spooky shooter from the creators of Sniper Elite 4! Hidden and Abominable Enemies."
