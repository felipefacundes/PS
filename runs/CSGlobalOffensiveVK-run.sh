...
SN="Counter-Strike: Global Offensive - Vulkan (DXVK)"
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -novid -high -nojoy -noforcemaccel -noforcemparms -noforcemspd -nod3d9ex -processheap -lv -tickrate 128 -refresh 120 -applaunch 730 \
