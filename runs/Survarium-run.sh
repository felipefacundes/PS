...
GN=Survarium
SN="Survarium (FPS)"
CME="Survarium is a post-apocalyptic online FPS game. If you are looking for a shooter where skills matter, look no further!"
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 355840 \
