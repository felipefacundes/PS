...
export GN="PlanetCoaster"
export SN="Planet Coaster"
export CME="The celebrated coaster park simulation game comes to your living room. Build your park."
