...
EXE2="GTAVLauncher.exe"
DIR2="$WINEPREFIX/drive_c/Program Files (x86)/Steam/steamapps/common/Grand Theft Auto V"
EXE3="Launcher.exe"
DIR3="$WINEPREFIX/drive_c/Program Files/Rockstar Games/Launcher"
