...
export GN="The_Crew_2"
export SN="The Crew 2"
export CME="The newest iteration in the revolutionary franchise, The Crew® 2 captures the thrill of the American motorsports spirit in one of the most exhilarating..."
