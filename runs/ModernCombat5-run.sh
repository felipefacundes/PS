...
export GN="ModernCombat5"
export SN="Modern Combat 5"
export CME="Modern Combat 5: Blackout is a first person shooter developed by Wil Lane Bucharest"
