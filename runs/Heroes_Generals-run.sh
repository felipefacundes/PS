...
GN=Heroes_Generals
SN="Heroes & Generals"
CME="Heroes & Generals is a full on, all-out WAR experience. Thousands of players fighting one massive clash of nations."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 227940 \
