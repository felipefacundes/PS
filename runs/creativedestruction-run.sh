...
CME="Creative Destruction is a FPS/TPS sandbox survival game that combines Battle Royale with a constructive concept."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 893520 \
