...
export GN="creativedestruction"
export SN="Creative Destruction"
export CME="Creative Destruction is a FPS/TPS sandbox survival game that combines Battle Royale with a constructive concept."
