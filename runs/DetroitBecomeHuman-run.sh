...
export GN="DetroitBecomeHuman"
export SN="Detroit Become Human"
export CME="Detroit: Become Human puts the destiny of both mankind and androids in your hands."
