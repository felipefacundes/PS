...
export GN="sth4e2"
export SN="Sonic The Hedgehog 4 episode 2"
export CME="Sonic the Hedgehog 4: Episode II is a video game from the Sonic the Hedgehog series."
...
EXE0="Sonic.exe"
DIR0="$WINEPREFIX/drive_c/Program Files (x86)/Sonic the Hedgehog 4 - Episode II"
