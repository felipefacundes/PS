...
export GN=RockstarGamesLauncher
export SN="Rockstar Games Launcher"
export CME="Rockstar Games Launcher - Rockstar Games Social Club"
...
EXE0="Launcher.exe"
DIR0="$WINEPREFIX/drive_c/Program Files/Rockstar Games/Launcher"
