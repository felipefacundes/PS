...
export GN="eve-online"
export SN="Eve Online"
export CME="EVE Online is a community-driven spaceship MMORPG where players can play free, choosing their own path from countless options."
