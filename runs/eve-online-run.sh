...
GN=eve-online
SN="Eve Online"
CME="EVE Online is a community-driven spaceship MMORPG where players can play free, choosing their own path from countless options."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 8500 \
