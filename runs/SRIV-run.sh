...
export GN="SRIV"
export SN="Saints Row IV"
export CME="All put together, Saints Row IV is a fantastic game, keeping up the series' tradition of giving players a wide open world."
