...
GN=SRIV
SN="Saints Row IV"
CME="All put together, Saints Row IV is a fantastic game, keeping up the series' tradition of giving players a wide open world."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 206420 \
