...
GN=SonicForces
SN="Sonic Forces"
CME="In SONIC FORCES, the evil Dr. Eggman has conquered much of the world with help from a powerful and mysterious new villain named Infinite."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 637100 \
