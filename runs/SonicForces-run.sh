...
export GN="SonicForces"
export SN="Sonic Forces"
export CME="In SONIC FORCES, the evil Dr. Eggman has conquered much of the world with help from a powerful and mysterious new villain named Infinite."
