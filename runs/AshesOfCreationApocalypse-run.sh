...
export GN="AshesOfCreationApocalypse"
export SN="Ashes of Creation Apocalypse"
export CME="Early Access for Ashes of Creation Apocalypse Battle Royale Testing Ends."
