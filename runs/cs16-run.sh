...
CME="Counter-Strike is a first-person shooter where two teams face off to reach a defined goal."
...
EXE="hl.exe"
cd "$WINEPREFIX/drive_c/Program Files (x86)/MONSTERSKILL/Counter-Strike Classic 2019"
