...
export GN="TW3"
export SN="The Witcher 3: Wild Hunt"
export CME="In The Witcher, you play as professional monster hunter Geralt of Rivia tasked with finding a child of prophecy in a vast open world."
