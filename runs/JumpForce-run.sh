...
export GN="JumpForce"
export SN="Jump Force"
export CME="The most famous Manga heroes are thrown into a whole new battleground: our world. Uniting to fight the most dangerous threat, the Jump Force"
