...
export GN="RaccooVentureDemo"
export SN="Raccoo Venture (Demo)"
export CME="Brazilian adventure game (by Diego Ras)"
...
EXE0="RaccooVenture_v1.0.295.exe"
DIR0="$WINEPREFIX/drive_c/RaccV"
