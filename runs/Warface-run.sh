...
export GN="Warface"
export SN="Warface"
export CME="Warface is a contemporary MMO first person shooter with millions of fans around the world. It offers intense PvP modes, compelling PvE."
