...
export GN="TOXIKK"
export SN="TOXIKK"
export CME="TOXIKK plays as if today's military and MOBA shooters never existed: The game combines the simple and intuitive mechanics of old-school FPS."
