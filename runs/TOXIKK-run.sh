...
GN=TOXIKK
SN="TOXIKK"
CME="TOXIKK plays as if today's military and MOBA shooters never existed: The game combines the simple and intuitive mechanics of old-school FPS."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -dx11 -applaunch 324810 \
