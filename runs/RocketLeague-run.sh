...
export GN="RocketLeague"
export SN="Rocket League"
export CME="Rocket League is an electronic in-vehicle soccer game - It is a clone of its predecessor: Supersonic Acrobatic Rocket-Powered Battle-Cars."
