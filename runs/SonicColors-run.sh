...
export GN="SonicColors"
export SN="Sonic Colors"
export CME="Sonic Colors: Ultimate. Join Sonic in this great adventure at full speed set in a colorful amusement park "
