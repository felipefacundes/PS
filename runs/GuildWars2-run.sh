...
export GN="GuildWars2"
export SN="Guild Wars 2"
export CME="MMORPG - Content updates that add story, rewards Base Comment more to the world of GW2"
...
EXE0="Gw2-64.exe"
DIR0="$WINEPREFIX/drive_c/Program Files/Guild Wars 2"
...
if [ "$Game_Actions" = "Run ${SN}" ]; then
    cd "$DIR0"
    "$W"/bin/wine "$EXE0" -dx9single -autologin \
    2>&1 | FPS_Xosd
fi
