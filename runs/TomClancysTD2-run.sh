...
export GN="TomClancysTD2"
export SN="Tom Clancy's The Division 2"
export CME="The Division 2 is a true RPG that offers more variety in missions and challenges."
...
EXE1="upc.exe"
DIR1="$WINEPREFIX/drive_c/Program Files (x86)/Ubisoft/Ubisoft Game Launcher"
