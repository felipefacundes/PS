...
export GN="MK11_Ultimate"
export SN="Mortal Kombat XI Ultimate"
export CME="Mortal Kombat XI Ultimate is back and better than ever in the next evolution of the iconic franchise. The all new Custom Character Variations give you unprecedented"
