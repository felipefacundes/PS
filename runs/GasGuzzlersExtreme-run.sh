...
CME="Gas Guzzlers Extreme is an exciting new twist on the car combat experience with the addition of furious team/clan combat battles."
...
if [ "$Game_Actions" = "Run ${SN}" ] ; then
    "$W"/bin/wine "$EXE" -applaunch 243800 \
