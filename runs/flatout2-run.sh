...
cd "/home/$USER/.jogos/wineprefixes/$GN/drive_c/FlatOut 2"
"$W"/bin/wine FlatOut2.exe 2>&1 | tee /dev/stderr | sed -u -n -e '/trace/ s/.*approx //p' | osd_cat --lines=1 --color=yellow --outline=1 --pos=top --align=left
