...
export GN="MetroExodus"
export SN="Metro Exodus"
export CME="Metro Exodus is an epic, story-driven first person shooter from 4A Games that blends deadly combat and stealth with exploration and survival."
