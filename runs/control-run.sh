...
export GN="control"
export SN="Control"
export CME="The perfect blend of narrative and gameplay, coherency and strangeness, Control is a game we'll be talking about for generations."
