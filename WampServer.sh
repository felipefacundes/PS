...
GN=WampServer
SN="WampServer"
CME="WampServer is a Windows web development environment"
...
#"$Wtricks" -q dotnet462 > /dev/null 2>&1
#"$Wtricks" -q dotnet472 > /dev/null 2>&1
...
cd ~/.PlayOnGit/setups/
rm -f wampserver3.2.3_x64.exe
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/-/raw/master/wampserver3.2.3_x64.exe
"$W"/bin/wine wampserver3.2.3_x64.exe
