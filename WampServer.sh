...
export GN="WampServer"
export SN="WampServer"
export CME="WampServer is a Windows web development environment"
...
Get https://www.opencode.net/felipefacundes/free-games/-/raw/master/wampserver3.2.3_x64.exe
