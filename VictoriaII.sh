...
export GN="VictoriaII"
export SN="Victoria II"
export CME="Victoria II is a grand strategy game played during the colonial era of the 19th century, where the player takes control of a country."
...
"$Wtricks" -q dotnet20 > /dev/null 2>&1
