...
export GN="Sekiro"
export SN="Sekiro Shadows Die Twice"
export CME="Carve your own clever path to vengeance in the critically acclaimed adventure from developer FromSoftware, creators of the Dark Souls series."
...
overrideDll dinput8
"$WINE" regsvr32 dinput8.dll
"$WINE64" regsvr32 dinput8.dll
...
echo "Progress ...."
"$Wtricks" autostart_winedbg=disabled nvapi=disabled nvapi64=disabled csmt=force windowmanagerdecorated=n grabfullscreen=y hosts nocrashdialog > /dev/null 2>&1
tput sgr0
