...
echo "Progress ...."
"$Wtricks" autostart_winedbg=disabled nvapi=disabled nvapi64=disabled csmt=force windowmanagermanaged=n grabfullscreen=y hosts nocrashdialog > /dev/null 2>&1
tput sgr0
