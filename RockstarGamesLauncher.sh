...
GN=RockstarGamesLauncher
SN="Rockstar Games Launcher"
CME="Rockstar Games Launcher - Rockstar Games Social Club"
...
cd "$WINEPREFIX"
wget --no-check-certificate -nc "https://github.com/felipefacundes/PS/blob/master/DXVK_SHADER_CACHE/GTAV/GTA5.dxvk-cache?raw=true" -O  Launcher.dxvk-cache
wget --no-check-certificate -nc https://raw.githubusercontent.com/felipefacundes/PS/master/Configs/RockstarLauncher/dxvk.conf

cd ~/.jogos/setups/
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/raw/master/Social-Club-Setup.exe
