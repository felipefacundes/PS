...
GN=PES2020
SN="PES 2020"
CME="PES 2020 (Futebol da Konami)"
...
wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/dxvk-1.4.4.tar.gz
#wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/d9vk/d9vk-0.13.tar.gz
tar -xf dxvk-1.4.4.tar.gz
...
cp -rf ~/.jogos/libraries/dxvk/dxvk-1.4.4/x64/* ~/.jogos/wineprefixes/"$GN"/drive_c/windows/system32/
cp -rf ~/.jogos/libraries/dxvk/dxvk-1.4.4/x32/* ~/.jogos/wineprefixes/"$GN"/drive_c/windows/syswow64/
echo "Em progresso ......"
