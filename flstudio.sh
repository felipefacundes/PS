...
export GN="flstudio"
export SN="FL Studio"
export CME="FL Studio, music production software is used every day to create the world's favorite music."
...
cd ~/.PlayOnGit/setups/
Get http://demodownload.image-line.com/flstudio/flstudio_win_20.5.1.1193.exe
