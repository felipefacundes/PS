...
GN=flstudio
SN="FL Studio"
CME="FL Studio, music production software is used every day to create the world's favorite music."
...
cd ~/.PlayOnGit/setups/
wget --no-check-certificate -nc http://demodownload.image-line.com/flstudio/flstudio_win_20.5.1.1193.exe
