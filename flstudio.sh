...
GN=flstudio
SN="FL Studio"
CME="FL Studio (editor profissional de audio)"
...
cd ~/.jogos/setups/
wget -nc http://demodownload.image-line.com/flstudio/flstudio_win_20.5.1.1193.exe
"$W"/bin/wine flstudio_win_20.5.1.1193.exe /S
