...
export WV=wine-staging-7.22-x86_64
...
Get https://github.com/doitsujin/dxvk/releases/download/v2.0/dxvk-2.0.tar.gz
tar -xf dxvk-2.0.tar.gz

cp -rf ~/.PlayOnGit/libraries/dxvk/dxvk-2.0/x64/* ~/.PlayOnGit/wineprefixes/"$GN"/drive_c/windows/system32/
cp -rf ~/.PlayOnGit/libraries/dxvk/dxvk-2.0/x32/* ~/.PlayOnGit/wineprefixes/"$GN"/drive_c/windows/syswow64/
