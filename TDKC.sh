...
CME="A fan-created remake of Donkey Kong Country (indie game)."
...
cd "$WINEPREFIX"
wget --no-check-certificate -nc https://raw.githubusercontent.com/felipefacundes/PS/master/Configs/TDKC/dxvk.conf
wget --no-check-certificate -nc "https://github.com/felipefacundes/PS/blob/master/DXVK_SHADER_CACHE/UDK.dxvk-cache?raw=true" -O UDK.dxvk-cache
cd "$WINEPREFIX/drive_c/"
wget --no-check-certificate -nc https://master.dl.sourceforge.net/project/indie-game/UDK.tar.xz
tput bold
tput setaf 3
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
