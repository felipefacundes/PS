...
GN=BatmanArkhamKnight
SN="Batman: Arkham Knight"
CME="Aventura com o personagem mais famoso da DC Comics"
...
~/.jogos/scripts/winetricks autostart_winedbg=disabled csmt=on grabfullscreen=y hosts nocrashdialog > /dev/null 2>&1
...
~/.jogos/scripts/winetricks -q physx
...
# Versão do Windows
~/.jogos/scripts/winetricks -q win10 csmt=on grabfullscreen=y > /dev/null 2>&1
