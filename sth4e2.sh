...
GN=sth4e2
SN="Sonic The Hedgehog 4 episode 2"
CME="Sonic the Hedgehog 4: Episode II is a video game from the Sonic the Hedgehog series."
...
cd ~/.PlayOnGit/setups/
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/raw/master/sh2oi2.tar.xz
tput bold
tput setaf 3
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Now, wait for the file to be extracted. It may take a while..." 
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
tar -xf sh2oi2.tar.xz
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
ps ax|egrep '*\.exe'|grep -v 'egrep'|awk '{print $1 }' | xargs kill -9 $1 ; pkill -9 .exe
cd dependence
cp -rf * "$WINEPREFIX/drive_c/Program Files (x86)/Sonic the Hedgehog 4 - Episode II"
cd ~/.PlayOnGit/libraries/
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/libraries/Gamepad2Keyboard_xinput.tar
tar -xf Gamepad2Keyboard_xinput.tar
cd Gamepad2Keyboard_xinput
cp -rf * "$WINEPREFIXdrive_c/Program Files (x86)/Sonic the Hedgehog 4 - Episode II"
"$Wtricks" xinput1_3=native
cd ~/.PlayOnGit/setups/
rm -f sh2oi2.tar.xz
rm -rf sh2oi2
