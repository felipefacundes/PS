...
"$Wtricks" -q quartz corefonts d3dx9 xact d3dcompiler_43 d3dcompiler_47 d3dx10 d3dx10_43 d3dx11_42 d3dx11_43 gdiplus > /dev/null 2>&1
...
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/libraries/l3codecx.ax > /dev/null 2>&1
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/libraries/mfc42.dll > /dev/null 2>&1
"$Wtricks" l3codecx=native mfc42=native > /dev/null 2>&1
...
wget --no-check-certificate -nc https://phoenixnap.dl.sourceforge.net/project/gapx/a5-2.tar.zst
tput bold
tput setaf 3
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
