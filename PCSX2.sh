...
cd "/home/$USER/.jogos/wineprefixes/$GN/drive_c/PCSX2 1.4.0/"
#"$W"/bin/wine pcsx2.exe 2>&1 | tee /dev/stderr | sed -u -n -e '/trace/ s/.*approx //p' | osd_cat --lines=1 --color=yellow --outline=1 --pos=top --align=left
