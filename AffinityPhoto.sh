...
#~/.jogos/scripts/winetricks -q comctl32 > /dev/null 2>&1
...
# d3dx9 xact d3dcompiler_43 d3dcompiler_47 d3dx10 d3dx10_43 d3dx11_42 d3dx11_43 
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "Em progresso ...."
~/.jogos/scripts/winetricks autostart_winedbg=disable csmt=off grabfullscreen=y hosts nocrashdialog > /dev/null 2>&1
...
#wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/dxvk-1.5.3.tar.gz
# wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/d9vk/d9vk-0.40.1.tar.xz
#tar -xf dxvk-1.5.3.tar.gz
...
cd ~/.jogos/setups/
wget -nc https://www.opencode.net/felipefacundes/free-games/raw/master/affinity-photo-1.7.3.exe
...
cd "/home/$USER/.jogos/wineprefixes/AffinityPhoto/drive_c/Program Files/Affinity/Photo/"
#"$W"/bin/wine Photo.exe
...
#wget -nc https://www.opencode.net/felipefacundes/free-games/raw/master/ChromeStandaloneSetup64.exe
