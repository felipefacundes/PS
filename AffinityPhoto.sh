...
export GN=AffinityPhoto
export SN="Affinity Photo"
export CME="Affinity Photo has become the world's first choice for photography and creative professionals, a testament to its speed, power and precision."
...
"$Wtricks" -q corefonts d3dx9 d3dcompiler_43 d3dcompiler_47 d3dx10 d3dx10_43 d3dx11_42 d3dx11_43 gdiplus > /dev/null 2>&1
...
cd ~/.PlayOnGit/setups/
rm -f affinity-photo-1.7.3.exe
Get https://www.opencode.net/felipefacundes/free-games/raw/master/affinity-photo-1.7.3.exe
