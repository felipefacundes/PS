...
export GN="TomClancysRainbowSixSiege"
export SN="Tom Clancy's Rainbow Six Siege"
export CME="Tom Clancy's Rainbow Six Siege is a first person shooter video game produced by Ubisoft Montreal."
