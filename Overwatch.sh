...
# mf
~/.jogos/scripts/winetricks -q richtx32 winhttp msftedit mshflxgd msflxgrd msdelta > /dev/null 2>&1
...
wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/dxvk-0.9.4.tar.gz
# wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/d9vk/d9vk-0.40.1.tar.xz
tar -xf dxvk-0.9.4.tar.gz
...
cp -rf ~/.jogos/libraries/dxvk/dxvk-0.9.4/x64/* ~/.jogos/wineprefixes/"$GN"/drive_c/windows/system32/
cp -rf ~/.jogos/libraries/dxvk/dxvk-0.9.4/x32/* ~/.jogos/wineprefixes/"$GN"/drive_c/windows/syswow64/
