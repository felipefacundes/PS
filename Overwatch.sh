...
export GN="Overwatch"
export SN="Overwatch"
export CME="Overwatch is a vibrant game set in the near future. Each match is a 6v6 battle with a roster of unique heroes."
...
Get https://raw.githubusercontent.com/felipefacundes/PS/master/Configs/Overwatch/Battle.net.config
cd "$WINEPREFIX/drive_c/Program Files (x86)"
Get "https://www.opencode.net/felipefacundes/free-games/raw/master/Battle.net.tar.zst"
