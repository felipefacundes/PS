...
wget --no-check-certificate -nc https://github.com/felipefacundes/desktop/blob/master/PS1/ePSXe202-1.tar.xz?raw=true -O ePSXe202-1.tar.xz
#wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/raw/master/psx-emulator-1.13.tar.xz
wget --no-check-certificate -nc https://github.com/felipefacundes/desktop/blob/master/PS1/psx-emulator-1.13.tar.xz?raw=true -O psx-emulator-1.13.tar.xz
#wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/raw/master/EmuCR-Pcsxr-r72232.tar.xz
wget --no-check-certificate -nc https://github.com/felipefacundes/desktop/blob/master/PS1/EmuCR-Pcsxr-r72232.tar.xz?raw=true -O EmuCR-Pcsxr-r72232.tar.xz
