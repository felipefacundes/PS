...
GN=mkdote-mugen
SN="Mortal Kombat Defenders of the Earth"
CME="Mortal Kombat Defenders of the Earth is a fangame that brings back characters from 2D games from the popular Midway saga (Mugen)."
...
wget --no-check-certificate -nc https://ufpr.dl.sourceforge.net/project/mkdfe/Rel_1/MK-Defenders-of-the-Earth-v3.3.7.tar
tput bold
tput setaf 3
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
rm -f mugen.cfg
wget --no-check-certificate -nc "https://www.opencode.net/felipefacundes/wine-bins/raw/master/configs/MortalKMugen-DFE/mugen.cfg?inline=false" -O mugen.cfg
