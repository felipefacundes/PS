...
mkdir -p ~/.jogos/wines/
mkdir -p ~/.jogos/icons/
mkdir -p ~/.jogos/librariesexport __GL_YIELD="NOTHING"
export __GL_SYNC_TO_VBLANK=0
export __GL_THREADED_OPTIMIZATIONS=1
export mesa_glthread=true/dxvk/
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
#~/.jogos/scripts/winetricks -q dotne462 > /dev/null 2>&1
#~/.jogos/scripts/winetricks -q xna40 > /dev/null 2>&1
