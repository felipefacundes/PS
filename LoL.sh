...
echo "rm -rf /home/$USER/.wine-appimage-lol/" >> remover-"$GN".sh
...
#wget -nc https://www.opencode.net/felipefacundes/wine-bins/raw/master/dxvk/d9vk/dxvk-release-lol.tar.xz
