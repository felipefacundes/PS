...
export GN=CEMU
export SN="CEMU Wii U Emulator"
export CME="Run Wii U Games" 
...
#Get https://www.opencode.net/felipefacundes/free-games/raw/master/cemu.tar.xz
Get https://master.dl.sourceforge.net/project/gapx/cemu.tar.zst
tar -xf cemu.tar.zst
