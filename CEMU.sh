...
#wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/raw/master/cemu.tar.xz
wget --no-check-certificate -nc https://master.dl.sourceforge.net/project/gapx/cemu.tar.zst
tar -xf cemu.tar.zst
