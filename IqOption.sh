...
export GN="IqOption"
export SN="IQ Option Broker"
export CME="IQ Option Broker is one of the fastest growing online trading."
...
cd ~/.PlayOnGit/setups/
rm -f IQOption.msi
Get https://www.opencode.net/felipefacundes/free-games/-/raw/master/IQOption.msi
