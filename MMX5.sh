...
export GN="MMX5"
export SN="Mega Man X5"
export CME="Mega Man X5, known as Rockman X5 (ロックマンX5) in Japan, is a video game developed by Capcom. It is the fifth main installment in the Mega Man X series."
...
Get https://www.opencode.net/felipefacundes/free-games/raw/master/MegamanX5.tar.xz
