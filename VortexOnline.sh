...
export GN="VortexOnline"
export SN="Vortex Online"
export CME="Games Streaming like Stadia"
...
cd ~/.PlayOnGit/setups/
rm -f VortexOnlineInstaller.exe
Get "http://dn01.vortex.gg/VortexOnlineInstaller.exe?&aff=" -O VortexOnlineInstaller.exe
"$W"/bin/wine VortexOnlineInstaller.exe
