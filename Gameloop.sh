...
GN=Gameloop
SN="GameLoop Android Emulator"
CME="GameLoop Android Emulator"
...
wget --no-check-certificate -nc https://www.opencode.net/felipefacundes/free-games/-/raw/master/Gameloop_installer_1000218273_com.tencent.ig.exe
