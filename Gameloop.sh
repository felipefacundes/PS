...
GN=Gameloop
SN="GameLoop Emulador de Android"
CME="GameLoop Emulador de Android"
...
cd ~/.jogos/setups/
rm -f Gameloop_installer_1000218273_com.tencent.ig.exe
wget -nc https://www.opencode.net/felipefacundes/free-games/-/raw/master/Gameloop_installer_1000218273_com.tencent.ig.exe
"$W"/bin/wine Gameloop_installer_1000218273_com.tencent.ig.exe
...
cd "$WINEPREFIX/drive_c/ProgramData/Microsoft/Windows/Start Menu/Programs/Tencent Software/Gameloop"
"$W"/bin/wine Gameloop.lnk
