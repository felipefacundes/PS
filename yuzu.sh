...
export WV=wine-tkg-staging-6.21.r1-x86_64
export GN="yuzu"
export SN="Yuzu (Nintendo Switch Emulator)"
export CME="Yuzu is an experimental open-source emulator for the Nintendo Switch from the creators of Citra."
...
Get https://www.opencode.net/felipefacundes/free-games/raw/master/yuzu-canary.tar.xz
tar -xf yuzu-canary.tar.xz

cd "$WINEPREFIX/drive_c/users/facundes/Application Data/"
Get https://www.opencode.net/felipefacundes/free-games/raw/master/yuzu-files.tar.xz
tar -xf yuzu-files.tar.xz

YUZUFOLDER="$WINEPREFIX/drive_c/users/facundes/Application Data/yuzu"
