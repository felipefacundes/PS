...
GN=Survarium
SN="Survarium (FPS)"
CME="FPS - Ação em primeira pessoa free to play"
...
~/.jogos/scripts/winetricks -q oleaut32 mf richtx32 winhttp msftedit mshflxgd msflxgrd msdxmocx msdelta > /dev/null 2>&1
